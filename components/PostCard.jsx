        ...
        <div className="bg-white shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8">
            ...
            <div className="block lg:flex text-center items-center justify-center mb-8 w-full">
                ...
                <div className="font-medium text-gray-700 mb-4">
                    ...
                    <span className="inline align-middle text-gray-700 ml-2">
            ...
            <div className="text-center">
                <Link href={`/post/${post.slug}`} passHref>
                    <span
                        className="transition duration-200 transform hover:-translate-y-1 inline-block bg-pink-600  text-lg font-medium rounded-full text-white px-8 py-3 cursor-pointer">
                        Continue Reading
                    </span>
                </Link>
            </div>
